...
<img align="right" alt="Coding" width="300" src="https://raw.githubusercontent.com/Anmol-Baranwal/Cool-GIFs-For-GitHub/main/coding-gif-for-github-2.gif"/>
...
### 🛡️ [XTI-SOC](https://github.com/Naman-1508/XTI-SOC)
...
- **0.83 ROC-AUC** dual-pipeline XGBoost classifier (binary + 7-class)
- Eliminated data leakage via chronological split + RobustScaler
- SHAP TreeExplainer → analyst-readable forensic insights
- Temporal correlation engine: Port Scans, DDoS, Brute Force, ARP Spoofing
- AbuseIPDB CTI enrichment with L1/L2 caching
- Real-time Next.js dashboard, WebSocket alerts, **sub-100ms latency**
...
- RESTful backend + role-based access control
- Real-time geospatial heatmaps via Leaflet
- YOLO-based vehicle detection from video streams
- Gemini API-powered incident severity classification
...
- MongoDB schemas + REST APIs for booking & itineraries
- ML microservice (Scikit-learn + FastAPI) for hospital ranking
- Secure global payments — Razorpay + Stripe
- 🏆 **Top 12 / 170+ teams** @ WHACKIEST'25 Hackathon
